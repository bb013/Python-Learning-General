...
crossroad = input('You are at a cross road. Where do you want to go? Type "left" or "right". ').lower()
if crossroad == "left":
    ...
    if lake == 'wait':
        ...
        if door == "red":
            print("Huh, flame throwers, who would have guessed? You are burned and die.\nGame Over.")
        elif door == "blue":
            print("You are attacked and eaten by a monster.\nGame Over")
        elif door == "yellow":
            print("You find a valuable tresure! You Win!")
        else:
            print("You choose a door that doesn't exist.\nGame Over")
    else:
        print("You are attacked by a giant squid!\nGame Over")
else:
